  ...
  return (
    ...
    >
      ...
      <div className={styles.container}>
        ...
        >
          <strong>MediMap</strong> makes it easy to find nearby hospitals based on your real-time location.
          Whether it's an emergency or just planning ahead, 
          MediMap gives you quick access to medical facilities with an interactive map and precise location details.
        </motion.p>
